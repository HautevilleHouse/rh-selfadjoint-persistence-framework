...
`Independent rerun completed on <UTC>. certificate SHA-256=<hash>. Gate tuple PASS/PASS/PASS/PASS/PASS on manifold_constrained lane. all_pass=true. Manifest verification ok=true.`
